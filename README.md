...
Correspondingly, the instructions for evaluating MLLMs can be obtained from another link:
[**Instructions**](https://drive.google.com/file/d/1uSD9N1zRqrdcwWyBfFAbXcasIEIb7M-D/view?usp=drive_link)

Additionally, we have contributed a lightweight out-of-distribution (OOD) data version, comprising approximately 150 characters in various calligraphic styles, which have undergone expert verification. Each character features a writing style distinct from that used in the Images. [**OOD Images**](https://drive.google.com/file/d/1TXqueWlv5AYCX8lQUN6a-2VyOtOZv3Fo/view?usp=drive_link)
